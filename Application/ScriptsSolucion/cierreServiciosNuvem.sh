...
#  SCRIPT DE DETENCION CONTROLADA DE LOS CONTENEDORES DOCKERIZADOS DE LA SOLUCION NUVEM CNCFLORA PORTAL
...
#  SCRIPT DE DETENCION CONTROLADA DE LOS CONTENEDORES DOCKERIZADOS DE LA SOLUCION NUVEM CNCFLORA PORTAL
#***********************************************************************************************************************************************
#  OBJETIVO:  Permitir la detencin controlada del nucleo (core) de Microservicios del Cluster de aplicaciones del Sistema NUVEM CNCFLORA y sus modulos:
#
...
#***********************************************************************************************************************************************
#  OBJETIVO:  Permitir la detencin limpia de todos los contenedores Docker de la Solucin NUVEM CNCFLORA
#***********************************************************************************************************************************************
#***********************************************************************************************************************************************
#***********************************************************************************************************************************************
DIA=`date +"%d/%m/%Y"`
...
echo " SCRIPT DE DETENCION CONTROLADA DE LOS CONTENEDORES DOCKERIZADOS DE LA SOLUCION NUVEM CNCFLORA PORTAL "
...
echo "***********************************************************************************************************************************"
echo "  SCRIPT DE DETENCION CONTROLADA DE LOS CONTENEDORES DOCKERIZADOS DE LA SOLUCION NUVEM CNCFLORA PORTAL "
echo "  OBJETIVO:  Permitir la detencin controlada del nucleo (core) de Microservicios del Cluster de aplicaciones del Sistema NUVEM CNCFLORA y sus modulos: "
